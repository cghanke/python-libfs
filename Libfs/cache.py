...
class Memcache:
    ...
    def add_inode_path_pair(self, inode, path):
        ...
        if inode not in self.inode2vpath_map:
            ...
            # cornercase: if have two files with identical metadata, the second has a counter appended: ' (libfs:%d)'.
            # if the metadata of the first one gets changed, the counter of the second disappears.
